...
filename = string("two_buoyancy_embayments_slope_stratified_asymmetric_WB700_Santee10_Nx_", Nx, "_Ny_", Ny, "_Nz_", Nz, "_spacing_", Int(inlet_center_spacing), "m_30min")
...
horizontal_biharmonic = HorizontalScalarBiharmonicDiffusivity(ν = ν₄h, κ = (b = κ₄h, c_santee = κ₄h, c_winyah = κ₄h))
vertical_biharmonic = VerticalScalarBiharmonicDiffusivity(ν = ν₄z, κ = (b = κ₄z, c_santee = κ₄z, c_winyah = κ₄z))
